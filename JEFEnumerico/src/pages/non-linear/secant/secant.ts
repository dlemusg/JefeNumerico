...
@IonicPage()
@Component({
  selector: 'page-secant',
  templateUrl: 'secant.html',
})
export class SecantPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SecantPage');
  }
  ...
  submitForm() {
    ...
    if (this.dataSubmit['f'] == '') {
      ...
      this.showAlert("ERROR:", "The field x1 can not be empty");
    ...
    let alert = this.alertCtrl.create({
      ...
      message: `<ul>
                  ...
                  <li> for more information go to the 
                    <a href="https://sites.google.com/view/jefeanumerico/non-linear-equations/open-methods/secant">
                    Page</a>
                  </li>
                </ul>`,
      buttons: ['OK']
