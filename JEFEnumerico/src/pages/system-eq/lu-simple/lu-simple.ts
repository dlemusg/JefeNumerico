...
@IonicPage()
@Component({
  selector: 'page-lu-simple',
  templateUrl: 'lu-simple.html',
})
export class LuSimplePage {
  private apiUrl  = 'https://tranquil-plateau-12350.herokuapp.com/lugausssimple';
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad LuSimplePage');
  }
  ...
  private help () {
    let alert = this.alertCtrl.create({
      ...
      message: ` <ul>
                      ...
                      <a href="https://sites.google.com/view/jefeanumerico/ecuation-systems/direct-methods/matrix-factorization/lu-with-gauss-simple">
                      Page</a>
                    </li>
                    </ul>`,
      buttons: ['OK']
