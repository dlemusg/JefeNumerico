...
export class CroutPage {
  private apiUrl  = 'https://tranquil-plateau-12350.herokuapp.com/croult';
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CroutPage');
  }
  ...
  private help () {
    let alert = this.alertCtrl.create({
      ...
      message: ` <ul>
                      ...
                      <a href="https://sites.google.com/view/jefeanumerico/ecuation-systems/direct-methods/matrix-factorization/crout">
                      Page</a>
                    </li>
                    </ul>`,
      buttons: ['OK']
