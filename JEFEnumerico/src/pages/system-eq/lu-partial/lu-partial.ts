...
@IonicPage()
@Component({
  selector: 'page-lu-partial',
  templateUrl: 'lu-partial.html',
})
export class LuPartialPage {
  private apiUrl  = 'https://tranquil-plateau-12350.herokuapp.com/lupartialpivoting';
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad LuPartialPage');
  }
  ...
  private help () {
    let alert = this.alertCtrl.create({
      ...
      message: ` <ul>
                      ...
                      <a href="https://sites.google.com/view/jefeanumerico/ecuation-systems/direct-methods/matrix-factorization/lu-with-gauss-and-partial-pivoting">
                      Page</a>
                    </li>
                    </ul>`,
      buttons: ['OK']
